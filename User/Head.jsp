				...
				<ul id="main-menu">
					...
					<li class="parent">
						...
						<ul class="sub-menu">
							...
							<li><a href="fruit.html">Friuts</a></li>
							</ul>
					</li>
...
<div class="banner">
	<div id="content">
        <div id="slider">
			...
			<img src="images/banner3.jpg" alt="E Agriculture" data-url="#3" >
	...
	<div class="container">
		<div class="row">
            <div class="col-lg-5 col-sm-6">
				<div class="content1">
					<h3 class="section-heading slideanim">Agriculture Building a Better Tomorrow.</h3>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-5 col-lg-offset-1 col-sm-push-6 col-sm-6">
				<div class="content2">
					<h3 class="section-heading slideanim">Something Special About The Agriculture</h3>
					<hr class="section-heading-spacer slideanim">
					<div class="clearfix"></div>
					</div>
			</div>
...
<div class="content-section-a">
	<div class="container">
		<div class="row">
            <div class="col-lg-5 col-sm-6">
				<div class="content3">
					<h3 class="section-heading slideanim">E Agriculture The Fresh Maker!</h3>
					<hr class="section-heading-spacer slideanim">
					<div class="clearfix"></div>
					</div>
			</div>
...
<footer class="text-center">
    ...
    <div class="footer-below">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <p>© 2016 E-Agriculture. All Rights Reserved </div>
            </div>
        </div>
