...
<div class="container"  style="background-color:#001a33;width:1390px; margin-left: -15px;"><nav class="navbar navbar-default" style="background-color:#6B8E23;"><div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        <li class="active"><a href="UserProfile.jsp" style="color: aliceblue;"><b>Home</b></a></li>
        ...
        <ul class="sub-menu" style="color: black;">
          <li><a href="../crop.html" style="color: aliceblue;" >Crops</a></li>
          <li><a href="../Vegetables.html" style="color: aliceblue;">Vegetables</a></li>
          <li><a href="../fruit.html"style="color: aliceblue;">Fruits</a></li>
        </ul>
      </li>
        <li><a href="../contact.html" style="color: aliceblue;"><b>ContactUs</b></a></li> 
      </ul>
			...
			<div class="col-sm-3"></div>
				<div class="col-md-6 mail-grid-left animated wow slideInLeft" data-wow-delay=".5s">
					<form action="EditUserPro.jsp" method="post">
						<label>Id:</label><br>
                        <input type="text" name="id" value="${UserList.regiId}" ><br><br>
						<label>First Name:</label><br>
                        <input type="text" name="FirstName" value="${UserList.firstName}" ><br><br>
                        <label>Last Name:</label><br>
                        <input type="text" name="LastName" value="${UserList.lastName }"><br><br>
						<label>Email Id:</label><br>
                        <input type="email" name="Email" value="${UserList.emailId }"><br><br>
						
						<label>Password:</label><br>
                        <input type="password" name="Password" value="${UserList.password }" ><br><br>
					
						<label>Gender:</label><br>
                        <input type="text" name="gender" value="${UserList.gender }"><br><br>
...
.mail-grid-left input[type="submit"] {
    ...
    margin-top: 10px;
                        ...
                        <input type="text" name="Address" value="${UserList.address }" ><br><br>
                    	
                        <br>
                        <br>
                        <label>Contact No:</label><br>
                        <input type="text" name="ContactNo" value="${UserList.contactNo }" ><br><br>
