...
<html>
<head>
<title>Agriculture</title><!-- for-mobile-apps -->
		...
		<div class="container">
			...
			<div class="col-sm-3"></div>
				<div class="col-md-6 mail-grid-left animated wow slideInLeft" data-wow-delay=".5s">
					<form action="../UserEditPro" method="post">
						<label>Id:</label><br>
                        <input type="text" name="id" value="${UserList.regiId}" required="" readonly="readonly"><br><br>
						<label>First Name:</label><br>
                        <input type="text" name="FirstName" value="${UserList.firstName}" required=""><br><br>
                        <label>Last Name:</label><br>
                        <input type="text" name="LastName" value="${UserList.lastName }" required=""><br><br>
						<label>Email Id:</label><br>
                        <input type="email" name="Email" value="${UserList.emailId }" required=""><br><br>
						
						<label>Password:</label><br>
                        <input type="password" name="Password" value="${UserList.password }" required><br><br>
...
.mail-grid-left input[type="submit"] {
    ...
    margin-top: 10px;
                        ...
                        <input type="text" name="ContactNo" value="${UserList.contactNo }" required=""><br><br>
