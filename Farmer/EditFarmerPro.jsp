		...
		<div class="container">
			...
			<div class="col-sm-3"></div>
				<div class="col-md-6 mail-grid-left animated wow slideInLeft" data-wow-delay=".5s">
					<form action="../FarmerEditPro" method="post">
						<label>Id:</label><br>
                        <input type="text" name="id" value="${FarmerList.regiId}" required="" readonly="readonly"><br><br>
						<label>First Name:</label><br>
                        <input type="text" name="FirstName" value="${FarmerList.firstName}" required=""><br><br>
                        <label>Last Name:</label><br>
                        <input type="text" name="LastName" value="${FarmerList.lastName }" required=""><br><br>
						<label>Email Id:</label><br>
                        <input type="email" name="Email" value="${FarmerList.emailId }" required=""><br><br>
						
						<label>Password:</label><br>
                        <input type="password" name="Password" value="${FarmerList.password }" required><br><br>
...
.mail-grid-left input[type="submit"] {
    ...
    margin-top: 10px;
                        ...
                        <input type="text" name="ContactNo" value="${FarmerList.contactNo }" required=""><br><br>
